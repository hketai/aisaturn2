...
const aiHandoffChatsList = useMapGetter('getAiHandoffChats');
...
const conversationList = computed(() => {
  ...
  if (!hasAppliedFiltersOrActiveFolders.value) {
    ...
    } else if (activeAssigneeTab.value === 'ai_handoff') {
      localConversationList = [...aiHandoffChatsList.value(filters)];
    } else {
