class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  ...
  def allowed_configs
    mapping = {
      ...
      'ikas' => %w[IKAS_CLIENT_ID IKAS_CLIENT_SECRET],
      ...
      'saturn' => saturn_config_options
    }

    @allowed_configs = mapping.fetch(@config, %w[ENABLE_ACCOUNT_SIGNUP FIREBASE_PROJECT_ID FIREBASE_CREDENTIALS])
  end

  def saturn_config_options
    %w[
      SATURN_OPEN_AI_API_KEY
      SATURN_OPEN_AI_MODEL
      SATURN_OPEN_AI_ENDPOINT
